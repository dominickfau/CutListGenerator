...
class FBPart(Base):
    ...
    products = relationship('FBProduct', foreign_keys='FBProduct.partId', back_populates='partObj')
    ...
    sizeUomObj = relationship('FBUom', backref='sizeUom', foreign_keys=[sizeUomId]) # type: FBUom
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}(id={self.id}, num={self.num}, description={self.description})"
