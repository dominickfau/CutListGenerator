...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionCut_Jobs_List = QtWidgets.QAction(MainWindow)
        self.actionCut_Jobs_List.setObjectName("actionCut_Jobs_List")
        self.actionTermination_Job_List = QtWidgets.QAction(MainWindow)
        self.actionTermination_Job_List.setObjectName("actionTermination_Job_List")
        self.actionSplice_Jobs_List = QtWidgets.QAction(MainWindow)
        self.actionSplice_Jobs_List.setObjectName("actionSplice_Jobs_List")
        self.actionProduct_List = QtWidgets.QAction(MainWindow)
        self.actionProduct_List.setObjectName("actionProduct_List")
        self.actionWire_Cutter_List = QtWidgets.QAction(MainWindow)
        self.actionWire_Cutter_List.setObjectName("actionWire_Cutter_List")
        self.actionWire_Cutter_Options_List = QtWidgets.QAction(MainWindow)
        self.actionWire_Cutter_Options_List.setObjectName("actionWire_Cutter_Options_List")
        ...
        self.menuExport.addAction(self.actionCut_Jobs_List)
        self.menuExport.addAction(self.actionTermination_Job_List)
        self.menuExport.addAction(self.actionSplice_Jobs_List)
        self.menuExport.addAction(self.actionProduct_List)
        self.menuExport.addAction(self.actionWire_Cutter_List)
        self.menuExport.addAction(self.actionWire_Cutter_Options_List)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCut_Jobs_List.setText(_translate("MainWindow", "Cut Jobs List"))
        self.actionCut_Jobs_List.setToolTip(_translate("MainWindow", "Exports all cut jobs awaiting to be cut."))
        self.actionCut_Jobs_List.setStatusTip(_translate("MainWindow", "Exports all cut jobs awaiting to be cut."))
        self.actionTermination_Job_List.setText(_translate("MainWindow", "Termination Job List"))
        self.actionTermination_Job_List.setToolTip(_translate("MainWindow", "Exports all cut jobs that are awaiting to be terminated."))
        self.actionTermination_Job_List.setStatusTip(_translate("MainWindow", "Exports all cut jobs that are awaiting to be terminated."))
        self.actionSplice_Jobs_List.setText(_translate("MainWindow", "Splice Jobs List"))
        self.actionSplice_Jobs_List.setToolTip(_translate("MainWindow", "Exports all cut jobs awaiting to be spliced."))
        self.actionSplice_Jobs_List.setStatusTip(_translate("MainWindow", "Exports all cut jobs awaiting to be spliced."))
        self.actionProduct_List.setText(_translate("MainWindow", "Product List"))
        self.actionProduct_List.setToolTip(_translate("MainWindow", "Export all products."))
        self.actionProduct_List.setStatusTip(_translate("MainWindow", "Export all products."))
        self.actionWire_Cutter_List.setText(_translate("MainWindow", "Wire Cutter List"))
        self.actionWire_Cutter_List.setToolTip(_translate("MainWindow", "Exports all wire cutters along with any assigned options."))
        self.actionWire_Cutter_List.setStatusTip(_translate("MainWindow", "Exports all wire cutters along with any assigned options."))
        self.actionWire_Cutter_Options_List.setText(_translate("MainWindow", "Wire Cutter Options List"))
        self.actionWire_Cutter_Options_List.setToolTip(_translate("MainWindow", "Exports all options that can be assigned to wire cutters."))
        self.actionWire_Cutter_Options_List.setStatusTip(_translate("MainWindow", "Exports all options that can be assigned to wire cutters."))
