...
from cutlistgenerator.database import Auditing, Base, Status, session
...
class SalesOrderStatus(Status):
    ...
    def find_by_id(id: int) -> SalesOrderStatus:
        return session.query(SalesOrderStatus).filter(SalesOrderStatus.id == id).first()

    @staticmethod
    def find_all() -> list[SalesOrderStatus]:
        return session.query(SalesOrderStatus).order_by(SalesOrderStatus.id).all()
    ...
    def create_default_data():
        ...
        backend_logger.info("Creating default data for SalesOrderStatus")
        data = [
...
class SalesOrderItemStatus(Status):
    ...
    def find_by_id(id: int) -> SalesOrderItemStatus:
        return (
            session.query(SalesOrderItemStatus)
    ...
    def create_default_data():
        """Creates the default data for the database."""
        backend_logger.info("Creating default data for SalesOrderItemStatus")
        data = [
...
class SalesOrderItemType(Base):
    ...
    def find_by_name(name: str) -> SalesOrderItemType:
        return session.query(SalesOrderItemType).filter_by(name=name).first()

    @staticmethod
    def create_default_data():
        """Creates the default data for the database."""
        backend_logger.info("Creating default data for SalesOrderItemType")
        data = [
        ...
        for item in data:
            x = (
                session.query(SalesOrderItemType)
...
class SalesOrder(Base, Auditing):
    ...
    def find_by_number(number: str) -> SalesOrder:
        return session.query(SalesOrder).filter(SalesOrder.number == number).first()
