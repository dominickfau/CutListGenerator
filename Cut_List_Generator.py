...
class MainWindow(Ui_MainWindow, QtWidgets.QMainWindow):
    ...
    def configure_settings(self):
        ...
        self.database_setup_completed = utilities.to_bool(
            self.settings.value("database_setup", False)
        )
    ...
    def get_so_table_data(
        self, progress_signal=None, progress_data_signal=None
    ) -> List[dict]:
    ...
    def get_current_fb_data(
        ...
        (
            ...
            fishbowl_database, cut_list_database, progress_signal, progress_data_signal
        )
